...
CREATE TABLE USERHISTORY(
    ...
    user_code CHAR(6) NOT NULL,
    userhistory_latitude NUMBER(10,8) NOT NULL,
    userhistory_longitude NUMBER(11,8) NOT NULL,
    userhistory_parkinglot_name VARCHAR2(50) NOT NULL,
    userhistory_parkinglot_addr VARCHAR2(200) NOT NULL,
    userhistory_parking_date DATE DEFAULT SYSDATE
);
COMMENT ON COLUMN USERHISTORY.userhistory_no IS '이용내역 코드번호';
COMMENT ON COLUMN USERHISTORY.user_code IS '회원코드';
COMMENT ON COLUMN USERHISTORY.userhistory_latitude IS '위도(0~90)';
COMMENT ON COLUMN USERHISTORY.userhistory_longitude IS '경도(0~180)';
COMMENT ON COLUMN USERHISTORY.userhistory_parkinglot_name IS '주차장이름';
COMMENT ON COLUMN USERHISTORY.userhistory_parkinglot_addr IS '주차장주소';
...
ALTER TABLE USERHISTORY
    ADD CONSTRAINT pk_userhistory PRIMARY KEY(userhistory_no);
ALTER TABLE USERHISTORY
...
CREATE TABLE PAYMENTHISTORY(
    ...
    paymenthistory_instt_name VARCHAR2(100),
    paymenthistory_instt_phone VARCHAR2(20),
...
COMMENT ON COLUMN PAYMENTHISTORY.paymenthistory_instt_name IS '관리기관명';
COMMENT ON COLUMN PAYMENTHISTORY.paymenthistory_instt_phone IS '관리기관 연락처';
...
ALTER TABLE PAYMENTHISTORY
    ADD CONSTRAINT fk_paymenthistory_userhistory FOREIGN KEY(paymenthistory_no) 
...
ALTER TABLE REVIEW
    ADD CONSTRAINT fk_review_userhistory FOREIGN KEY(review_no) REFERENCES userhistory(userhistory_no)
    ON DELETE CASCADE;
ALTER TABLE REVIEW
...
CREATE TABLE BOOKMARK(
    ...
    user_code CHAR(6) NOT NULL,
    bookmark_latitude NUMBER(10,8) NOT NULL,
    bookmark_longitude NUMBER(11,8) NOT NULL
);
COMMENT ON COLUMN BOOKMARK.bookmark_no IS '북마크번호';
COMMENT ON COLUMN BOOKMARK.user_code IS '회원코드';
COMMENT ON COLUMN BOOKMARK.bookmark_latitude IS '위도(0~90)';
COMMENT ON COLUMN BOOKMARK.bookmark_longitude IS '경도(0~180)';
