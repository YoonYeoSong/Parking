...
public class Parking {
	...
	private int fulltimeMonthly;		// 월 정기권 금액
	private int grpParkNm;				// 노상 주차장 관리그룹번호
	...
	private int dayMaximum;				// 버스 추가 단위 요금
	...
	public Parking(String parkingCode, String parkingName, String addr, String parkingType, String parkingTypeNm,
			...
			String saturdayPayYn, String saturdayPayNm, String holidayPayYn, String holidayPayNm, int fulltimeMonthly,
			int grpParkNm, int rates, int timeRate, int addRates, int addTimeRate, int busRates, int busTimeRate,
			int busAddTimeRate, int dayMaximum, double latitude, double hardness, String assignCode,
	...
	public int getFulltimeMonthly() {
		return fulltimeMonthly;
	}

	public void setFulltimeMonthly(int fulltimeMonthly) {
		this.fulltimeMonthly = fulltimeMonthly;
	}

	public int getGrpParkNm() {
		return grpParkNm;
	}

	public void setGrpParkNm(int grpParkNm) {
		this.grpParkNm = grpParkNm;
	}
...
//				<ASSIGN_CODE_NM>미배정,미점유</ASSIGN_CODE_NM>
	...
	public String toString() {
		return "Parking [parkingCode=" + parkingCode + ", parkingName=" + parkingName + ", addr=" + addr
				...
				+ ", curParkingTime=" + curParkingTime + ", payYn=" + payYn + ", payNm=" + payNm + ", nightFreeOpen="
				+ nightFreeOpen + ", nightFreeOpenNm=" + nightFreeOpenNm + ", weekdayBeginTime=" + weekdayBeginTime
				+ ", weekdayEndTime=" + weekdayEndTime + ", weekendBeginTime=" + weekendBeginTime + ", weekendEndTime="
				+ weekendEndTime + ", holidayBeginTime=" + holidayBeginTime + ", holidayEndTime=" + holidayEndTime
				+ ", syncTime=" + syncTime + ", saturdayPayYn=" + saturdayPayYn + ", saturdayPayNm=" + saturdayPayNm
				+ ", holidayPayYn=" + holidayPayYn + ", holidayPayNm=" + holidayPayNm + ", fulltimeMonthly="
				+ fulltimeMonthly + ", grpParkNm=" + grpParkNm + ", rates=" + rates + ", timeRate=" + timeRate
				+ ", addRates=" + addRates + ", addTimeRate=" + addTimeRate + ", busRates=" + busRates
				+ ", busTimeRate=" + busTimeRate + ", busAddTimeRate=" + busAddTimeRate + ", dayMaximum=" + dayMaximum
				+ ", latitude=" + latitude + ", hardness=" + hardness + ", assignCode=" + assignCode + ", assignCodeNm="
				+ assignCodeNm + ", insttNm=" + insttNm + "]";
	}
